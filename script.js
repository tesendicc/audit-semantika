...
// - Errors are written into each field's linked error element
//   (aria-describedby), not just shown visually.
// - aria-invalid is set/cleared on the field itself.
// - Focus moves to the first invalid field on submit.
// - A polite live region announces the overall result.
// -----------------------------------------------------------
...
// Validate on blur so people get feedback as they go, not only on submit.
